Design or refine an experiment-only portable skill for the task: Ligand-Receptor Discovery.
...
Constraints:
- Only create or modify files under `experiments/sc_skills/ligand-receptor-discovery`.
