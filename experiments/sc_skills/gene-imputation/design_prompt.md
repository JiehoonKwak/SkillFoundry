Design or refine an experiment-only portable skill for the task: Spatial Gene Imputation.
...
Constraints:
- Only create or modify files under `experiments/sc_skills/gene-imputation`.
