Design or refine an experiment-only portable skill for the task: Cell-Cell Communication Analysis.
...
Constraints:
- Only create or modify files under `experiments/sc_skills/cell-cell-communication`.
