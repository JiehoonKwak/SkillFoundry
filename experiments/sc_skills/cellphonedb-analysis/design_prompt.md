Design or refine an experiment-only portable skill for the task: CellPhoneDB Ligand-Receptor Analysis.

Task goal:
Run CellPhoneDB in a portable way and summarize statistically supported interaction programs.

Constraints:
- Only create or modify files under `experiments/sc_skills/cellphonedb-analysis`.
